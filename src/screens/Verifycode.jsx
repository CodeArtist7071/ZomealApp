...
const Verifycode=({onChangeText,keyboardType,onFilled,confirmEvent,value,handleLinkEvent})=>{
...
<Box w={'$90'} h={'$90'} flex={1} justifyContent="center" alignItems="center"> 
  ...
  <HStack py={'$10'} justifyContent="center">
    ...
    <CustomLink text={'RESEND OTP'} onPress={handleLinkEvent} linkColor={textColor} linkFontWeight={700}/>
  </HStack>
</Box>
  </LinearGradient>
